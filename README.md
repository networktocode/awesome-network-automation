...
Network Automation is a cross between the discipline of Network Infrastructure and the discipline of Programming. Network Automation (also called "Network Programmability") leverages applications, APIs, and networking device capabilities to make networking infrastructure easier to manage and less prone to failure.
